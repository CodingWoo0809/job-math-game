export const ASSET_MANIFEST = Object.freeze({
  characters: Object.freeze({
    ...
    bicycleStudent: "./assets/characters/sprites/bicycle_student.png",
    ...
    forestRestorationWorker: "./assets/characters/sprites/forest_restoration_worker.png",
    bullyBrothers: "./assets/characters/sprites/bully_brothers.png",
    delinquentMonkey: "./assets/characters/sprites/delinquent_monkey.png",
    captorRobot: "./assets/characters/sprites/captor_robot.png",
    blackSuitAgents: Object.freeze({
      agent01: "./assets/characters/sprites/black_suit_agent_01.png",
      agent02: "./assets/characters/sprites/black_suit_agent_02.png",
      agent03: "./assets/characters/sprites/black_suit_agent_03.png",
      agent04: "./assets/characters/sprites/black_suit_agent_04.png",
      agent05: "./assets/characters/sprites/black_suit_agent_05.png"
    }),
  ...
  buildings: Object.freeze({
    ...
    schoolBuilding: "./assets/buildings/sprites/school_building.png",
    stationeryStore: "./assets/buildings/sprites/stationery_store.png",
  ...
  props: Object.freeze({
    ...
    nutrientMixingMachine: "./assets/props/sprites/nutrient_mixing_machine.png",
    blockedChainBarrier: "./assets/props/sprites/blocked_chain_barrier.png",
    openChainBarrier: "./assets/props/sprites/open_chain_barrier.png",
    brokenStreetlight: "./assets/props/sprites/broken_streetlight.png",
    streetlight: "./assets/props/sprites/streetlight.png",
    flickeringStreetlight: "./assets/props/sprites/flickering_streetlight.png",
    futureBaseWallTile: "./assets/props/future_base_wall_tile.png",
    futureBaseSlidingDoor: "./assets/props/future_base_sliding_door.png",
    alleyWalls: Object.freeze({
      wall01: "./assets/props/sprites/alley_wall_01.png",
      wall02: "./assets/props/sprites/alley_wall_02.png",
      wall03: "./assets/props/sprites/alley_wall_03.png",
      wall04: "./assets/props/sprites/alley_wall_04.png",
      wall05: "./assets/props/sprites/alley_wall_05.png",
      wall06: "./assets/props/sprites/alley_wall_06.png",
      wall07: "./assets/props/sprites/alley_wall_07.png",
      wall08: "./assets/props/sprites/alley_wall_08.png",
      wall09: "./assets/props/sprites/alley_wall_09.png",
      wall10: "./assets/props/sprites/alley_wall_10.png",
      wall11: "./assets/props/sprites/alley_wall_11.png",
      wall12: "./assets/props/sprites/alley_wall_12.png"
    }),
    ...
    closedIronGate: "./assets/props/sprites/closed_iron_gate.png",
    openIronGate: "./assets/props/sprites/open_iron_gate.png",
    ...
    filmingPlanEasel: "./assets/props/sprites/filming_plan_easel.png",
    gameGuideEasel: "./assets/props/sprites/game_guide_easel.png",
